...
export const metadata: Metadata = {
  title: 'Delizia Kitchen — Restaurant Website Demo',
  description: 'A beautifully crafted restaurant website demo featuring curated menu sections, vibrant food photography, and inviting layouts. Designed by Ezepue Williams',
};
